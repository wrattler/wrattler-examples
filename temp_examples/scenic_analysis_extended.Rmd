...
for (i in seq_len(nrow(d))) {
  ...
  geom_histogram(data=subset(crime_subset_df, label == 0), binwidth=w,  fill = "#E89005", alpha = 0.9) + # lowest crime count
  geom_histogram(data=subset(crime_subset_df, label == 1), binwidth=w, fill = "#2292A4", alpha = 0.9) +
  geom_histogram(data=subset(crime_subset_df, label == 2), binwidth=w, fill = "#485665", alpha = 0.9) +
